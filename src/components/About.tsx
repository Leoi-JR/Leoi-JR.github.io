const SKILLS = [
  ...
  {
    label: 'LLM / RAG',
    items: ['RAG Pipeline', 'BM25 + Embedding + Reranker + RRF', 'HyDE', 'Prompt Engineering'],
  },
  {
    label: '数据处理',
    items: ['Pandas · NumPy · SciPy', 'PyArrow / Parquet', 'MySQL · PostgreSQL'],
  },
  {
    label: '编程语言',
  ...
  {
    label: '后端 / 前端',
    items: ['Flask · React · Next.js', 'HTML / CSS（Vue 了解）'],
  },
  {
    label: '工具链',
    items: ['Git / GitHub · Docker · Linux', 'Claude Code · Cursor · Copilot'],
  },
]
    ...
    <section className="about section" id="about" aria-label="关于我">
      ...
      <div className="about__box content-width">
        ...
        <p className="about__para">
          研究生阶段深耕空间计算与轨迹表征学习，参与发表 SCI 论文 2 篇；
          毕业后在规划设计行业担任数据/算法工程师近两年，围绕产业经济数据的智能化分析，
          独立构建了一套完整工具链——从关键词规则引擎、向量 Embedding 流水线，到 LLM 驱动的 RAG 报告生成系统，
